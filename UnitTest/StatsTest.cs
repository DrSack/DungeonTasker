...
namespace UnitTest
{
    public class StatsTest
    {
        ...
        //[Fact]
        //public void TestUserStatsExpCheck()
        //{
        //    string tempFile = Path.GetTempFileName();//create a temporary file
        //    File.WriteAllText(tempFile, "HEALTH:100\nMANA:40\nLEVEL:1\nEXP:36");//Create values
        //    StatsModel test = new StatsModel(tempFile);
        //    Assert.True(test.StatsCheckAsync());//Check if its time for a levelup
        //}

        //[Fact]
        //public void TestUserStatsExpCheckFalse()
        //{
        //    string tempFile = Path.GetTempFileName();//create a temporary file
        //    File.WriteAllText(tempFile, "HEALTH:100\nMANA:40\nLEVEL:1\nEXP:0");//Create values
        //    StatsModel test = new StatsModel(tempFile);
        //    Assert.False(test.StatsCheckAsync());//Check if not ready to lvl up
        //}
        ...
        //[Fact]
        //public void TestUserStatsExpCOMBO()
        //{
        //    string tempFile = Path.GetTempFileName();//create a temporary file
        //    File.WriteAllText(tempFile, "HEALTH:100\nMANA:40\nLEVEL:1\nEXP:0");//Create values
        //    StatsModel test = new StatsModel(tempFile);
